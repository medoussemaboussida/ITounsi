...
List<Widget> _screens = [News(), Events(), Profile()];
List<String> _title = ["News management", "Events Management", "Profiles managements"];

class _MyWidgetState extends State<Adminhome> with SingleTickerProviderStateMixin {
          ...
          child: ListView(
            children: [
              DrawerHeader(
                decoration: BoxDecoration(
                   image: DecorationImage(
                    image: AssetImage("assets/drawer.png"), // Chemin de votre image
                    fit: BoxFit.cover,
                    ),
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.push(context, CupertinoPageRoute(builder: ((context) => Addnews())));
                },
              ),
              ListTile(
                leading: RotationTransition(
